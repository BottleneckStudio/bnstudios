...
describe("middleware/rate-limiter", () => {
  ...
  it("should accept custom window and limit", () => {
    ...
    expect(rateLimit).toHaveBeenCalledWith(expect.objectContaining({ windowMs: 60000, limit: 10 }));
  });
  ...
  it("should accept custom message", () => {
    ...
    expect(rateLimit).toHaveBeenCalledWith(expect.objectContaining({ message: customMessage }));
  });
});
